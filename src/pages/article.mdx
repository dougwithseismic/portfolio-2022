...
export const meta = {
  title: 'How to use the React Hooks API',
  synopsis: `If you are using the React Hooks API chances are you are already familiar with it. But if not, here's a primer. Now I should be able to write articles directly from this file.`,
  date: '2020-10-16',
