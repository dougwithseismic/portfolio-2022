      ...
      >
        <div className="container px-8">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="hero">
              <h2 className="text-hero m-0 md:text-jumbo max-w-2xl">
                Micro-site{' '}
                <span className="text-brightOrange">Hook Development</span>
              </h2>
            </div>
          </div>
          <p className="text-2xl max-w-2xl mt-8 md:p-4 text-faintGrey">
            Enter the most genuine and lucrative way to show you care about the
            space you're in, and one of your best investments this year... but
          ...
          <div className="introContent flex flex-col md:flex-row items-center gap-16 py-16 my-32">
            ...
            <div className="rightContent flex flex-col gap-8 order-2">
              <p className="text-2xl max-w-2xl m-0">
                We build conversion-focused micro-sites that solidify your
                brands expertise so when the time is right, customers already
                know your name.
              </p>
            </div>
          </div>
...
const SERVICES = [
  {
    name: 'Content Microsites',
    link: '#content-',
    description: `Build `,
  },
  {
    name: 'Product-led Marketing',
    link: '#product-led',
